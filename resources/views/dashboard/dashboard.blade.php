                ...
                <div class="col-3">
                    <div class="card">
                        <div class="card-body text-center" style="padding: 12px 12px !important; line-height:0.8rem">
                            ...
                            <ion-icon name="newspaper-outline" style="font-size: 1.6rem; color: #206bc4"
                                class=" mb-1"></ion-icon>
                            <br>
                ...
                <div class="col-3">
                    <div class="card">
                        <div class="card-body text-center" style="padding: 12px 12px !important; line-height:0.8rem">
                            ...
                            <ion-icon name="medkit-outline" style="font-size: 1.6rem; color: #206bc4"
                                class=" mb-1"></ion-icon>
                            <br>
                ...
                <div class="col-3">
                    <div class="card">
                        <div class="card-body text-center" style="padding: 12px 12px !important; line-height:0.8rem">
                            ...
                            <ion-icon name="document-outline" style="font-size: 1.6rem; color: #206bc4"
                                class="mb-1"></ion-icon>
                            <br>
                                ...
                                <div class="card-body">
                                    <div class="historicontent">
                                        <div class="iconpresensi">
                                            <ion-icon name="finger-print-outline" style="font-size: 48px; bacground-color: #206bc4"
